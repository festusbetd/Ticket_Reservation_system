...
<title>BOMET TRAVELLERS TICKET</title>
...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">BOMET TRAVELLERS TICKET</a>
    </div><br>
...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>Bomet to Kericho</option>
      <option>Kericho to Bomet</option>
	   <option>Bomet to Nairobi</option>
	    <option>Nairobi to Bomet</option>
    </select>
  </div>   
  </div>
<div class="field">  
...
<input type="text" readonly required id="traveldate" class="datepicker-here form-control" placeholder="ex. August 03, 2018">
  </div>  
  </div>
...
<label>Payment</label>  
    <select name="gender" required id="paymentmethod">
      ...
      <option value="KCD_BANK">AIRTEL MONEY</option>
	  <option value="EQUITY_BANK">BMS Card</option>
    </select>
  </div> 
<div class="field"> 
...
<div class="ui icon input">
  <input value="702.70" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">

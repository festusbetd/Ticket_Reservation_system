...
<html>
  ...
  <body>
	...
	<div class="ui grid">
        ...
        <div class="ui horizontal divider"> festus Bett</div>      
		<div class="row">
        <div class="ui segment">
  <img class="ui centered medium circular image" src="developer.jpg"><br>
  <div class="ui horizontal divider">About me</div>
		<p>Hi, there!. This is festus Bett, the developer of this systemm. I love programming, i really do, it happens to be my hobby. Its what i do best</p> 
		<div class="ui horizontal divider">Contacts Details</div>
		<p>Wondering where to find me? Reach me at;<br> Email: <a>festusbet@gmail.com</a> <br>Personal Contact : <a>+2547229862</a><br> I am willing to teach new programmers</p>
		</div>		
        </div>
			</div>	
		</div>
